...
# Finding th emean for Method 2 of Intervention
df = pd.read_csv("method2.csv")
data = df["Math_score"].to_list()
meanOfMTD2 = st.mean(data)

print("The mean of Method 2: ", meanOfMTD2)

fig = ff.create_distplot([meanList], ["Student Marks"], show_hist=False)
fig.add_trace(go.Scatter(x = [sampleMean, sampleMean], y = [0, 0.17], mode="lines", name = "mean"))
fig.add_trace(go.Scatter(x = [meanOfMTD2, meanOfMTD2], y = [0, 0.17], mode="lines", name="method2"))
fig.add_trace(go.Scatter(x = [firstSDEnd, firstSDEnd], y = [0, 0.17], mode="lines", name = "SD1"))
fig.add_trace(go.Scatter(x = [secondSDEnd, secondSDEnd], y = [0, 0.17], mode="lines", name = "SD2"))
fig.add_trace(go.Scatter(x = [thirdSDEnd, thirdSDEnd], y = [0, 0.17], mode="lines", name = "SD3"))
fig.show()

# Finding th emean for Method 3 of Intervention
df = pd.read_csv("method3.csv")
data = df["Math_score"].to_list()
meanOfMTD3 = st.mean(data)

print("The mean of Method 3: ", meanOfMTD3)

fig = ff.create_distplot([meanList], ["Student Marks"], show_hist=False)
fig.add_trace(go.Scatter(x = [sampleMean, sampleMean], y = [0, 0.17], mode="lines", name = "mean"))
fig.add_trace(go.Scatter(x = [meanOfMTD3, meanOfMTD3], y = [0, 0.17], mode="lines", name="method3"))
fig.add_trace(go.Scatter(x = [firstSDEnd, firstSDEnd], y = [0, 0.17], mode="lines", name = "SD1"))
fig.add_trace(go.Scatter(x = [secondSDEnd, secondSDEnd], y = [0, 0.17], mode="lines", name = "SD2"))
fig.add_trace(go.Scatter(x = [thirdSDEnd, thirdSDEnd], y = [0, 0.17], mode="lines", name = "SD3"))
fig.show()
...
# Finding z-score
zScore = (sampleMean - meanOfMTD3) / sampleSTD
